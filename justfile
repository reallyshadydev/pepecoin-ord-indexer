...
# HTTP smoke test: hits every axum route (needs `ord server` running).
# Override URL: `just smoke-api url=http://127.0.0.1:8888`
smoke-api url='http://127.0.0.1:8888':
  ORD_BASE_URL={{url}} python3 scripts/smoke_local_ord.py
